                    ...
                    <Card key={trip.Id || trip.id} className="trip-card border-0 shadow-sm" style={{ width: '100%', maxWidth: '100%', marginBottom: '2.5rem', boxShadow: '0 8px 24px 0 rgba(37,99,235,0.25) !important' }}>
                      <Card.Body className="p-3 p-md-4">
                        ...
                        <div className="trip-details">
                          <div className="trip-detail-row lcp-row" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: '2rem', width: '100%', flexWrap: 'nowrap', padding: '0.5rem 0', overflowX: 'auto' }}>
                            {/* Date */}
                            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 0 }}>
                              <span className="trip-calendar-icon" style={{ flexShrink: 0, margin: 0, padding: 0, background: 'none' }}>
                              ...
                              <span className="trip-label" style={{ margin: 0, fontWeight: 500 }}>Date</span>
                              <span className="trip-value ms-2" style={{ marginLeft: 0, color: '#2563eb', fontWeight: 600, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{formatDate(trip.StartTime || trip.startTime)}</span>
                            </div>
                            {/* Distance */}
                            <div style={{ display: 'flex', alignItems: 'center', minWidth: '220px', flex: '1 1 0', overflow: 'hidden', whiteSpace: 'nowrap' }}>
                              <span className="trip-distance-icon" style={{ flexShrink: 0 }}>
                              ...
                              <span className="trip-label" style={{ marginLeft: 14, fontWeight: 500 }}>Distance</span>
                              <span className="trip-value text-success ms-2" style={{ marginLeft: 8, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{(trip.DistanceKm || trip.distanceKm)?.toLocaleString('hu-HU', { minimumFractionDigits: 1, maximumFractionDigits: 1 }) || 'N/A'} km</span>
                            </div>
                            {/* Plate */}
                            <div style={{ display: 'flex', alignItems: 'center', minWidth: '220px', flex: '1 1 0', overflow: 'hidden', whiteSpace: 'nowrap' }}>
                              <span className="trip-plate-icon" style={{ flexShrink: 0 }}>
                              ...
                              <span className="trip-label" style={{ marginLeft: 4, fontWeight: 500 }}>Plate</span>
                              <span className="trip-value ms-2" style={{ marginLeft: 8, color: '#fb923c', fontWeight: 600, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{trip.LicensePlate || trip.licensePlate}</span>
                            </div>
                          </div>
                        </div>
                      </Card.Body>
